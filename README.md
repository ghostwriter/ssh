...
[![Automation](https://github.com/ghostwriter/ssh/actions/workflows/automation.yml/badge.svg)](https://github.com/ghostwriter/ssh/actions/workflows/automation.yml)
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/ssh?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/ssh?color=F28D1A)](https://packagist.org/packages/ghostwriter/ssh)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/ssh&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/ssh
```
...
- [All Contributors](https://github.com/ghostwriter/ssh/contributors)
